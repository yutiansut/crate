...
public class RamBlockSizeCalculator implements IntSupplier {
    ...
    public int getAsInt() {
        ...
        // - Integer.MAX_VALUE because that's the limit of our buffer
        // - defaultBlockSize because:
        ...
        //      is sent.
        int cap = (int) Math.min(Math.min(Integer.MAX_VALUE, numberOfRowsForLeft), defaultBlockSize);
