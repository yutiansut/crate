...
public class FetchIdStub extends Symbol {

    private final DocTableRelation relation;
    private final Collection<Symbol> fetchCandidates;
    private final Reference fetchId;

    public FetchIdStub(DocTableRelation relation, Collection<Symbol> fetchCandidates) {
    ...
    public Collection<Symbol> fetchCandidates() {
