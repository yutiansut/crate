...
public class SymbolVisitor<C, R> {
    ...
    public R visitScopedSymbol(ScopedSymbol field, C context) {
    ...
    public R visitColumnAlias(ColumnAlias columnAlias, C context) {
        return columnAlias.symbol().accept(this, context);
    }
}
