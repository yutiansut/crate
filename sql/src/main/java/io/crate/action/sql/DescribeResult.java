...
public class DescribeResult {
    ...
    @Nullable
    private final List<? extends Symbol> fields;
    @Nullable
    private DataType[] parameters;

    DescribeResult(@Nullable List<? extends Symbol> fields) {
        this.fields = fields;
    }

    DescribeResult(@Nullable List<? extends Symbol> fields, @Nullable DataType[] parameters) {
        this.fields = fields;
        this.parameters = parameters;
    }

    @Nullable
    public List<? extends Symbol> getFields() {
        return fields;
    }
